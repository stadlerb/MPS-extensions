...
<language namespace="de.itemis.mps.modelmerger" uuid="cdaf53d5-8786-43a0-bdba-ae0da5acb9e8" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator alias="main" namespace="de.itemis.mps.modelmerger#01" uuid="a33d9f4f-61f6-4392-b5ed-5b975979edc8">
      <models>
      ...
      <languageVersions>
        <language slang="l:cdaf53d5-8786-43a0-bdba-ae0da5acb9e8:de.itemis.mps.modelmerger" version="0" />
      ...
      <dependencyVersions>
        ...
        <module reference="cdaf53d5-8786-43a0-bdba-ae0da5acb9e8(de.itemis.mps.modelmerger)" version="0" />
        <module reference="a33d9f4f-61f6-4392-b5ed-5b975979edc8(de.itemis.mps.modelmerger#01)" version="0" />
        <module reference="efc9f360-4711-4223-b9a5-469bba1c960d(de.itemis.mps.modelmerger.runtime)" version="0" />
      ...
      <mapping-priorities>
        <mapping-priority-rule kind="strictly_before">
          <greater-priority-mapping>
            <generator generatorUID="a33d9f4f-61f6-4392-b5ed-5b975979edc8(de.itemis.mps.modelmerger#01)" />
            <external-mapping>
              <all-local-mappings />
            </external-mapping>
          </greater-priority-mapping>
  ...
  <dependencies>
    ...
    <dependency reexport="false">cdaf53d5-8786-43a0-bdba-ae0da5acb9e8(de.itemis.mps.modelmerger)</dependency>
    <dependency reexport="true">efc9f360-4711-4223-b9a5-469bba1c960d(de.itemis.mps.modelmerger.runtime)</dependency>
    <dependency reexport="false" scope="generate-into">c0080a47-7e37-4558-bee9-9ae18e690549(jetbrains.mps.lang.extension)</dependency>
